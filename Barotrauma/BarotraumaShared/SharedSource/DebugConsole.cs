...
namespace Barotrauma
{
    ...
    static partial class DebugConsole
    {
        ...
        static DebugConsole()
        {
            ...
            commands.Add(new Command("debugmenu", "debugmenu [menu]: Open a debug menu (client-only).", null, () => new string[][] { new string[] { "closeall", "entityexplorer", "guiexplorer", "inspect" }, new string[] { "entities", "gui" } }, isCheat: true));
