    ...
    partial class HumanAIController : AIController
    {
        ...
        public override void DebugDraw(Microsoft.Xna.Framework.Graphics.SpriteBatch spriteBatch)
        {
            ...
            if (ObjectiveManager != null)
            {
                ...
                {
                    GUI.DrawString(spriteBatch, pos + textOffset, $"ORDER: {currentOrder.DebugTag} ({currentOrder.GetPriority(ObjectiveManager)})", Color.White, Color.Black);
                }
                ...
                if (currentObjective != null)
                {
                    ...
                    {
                        GUI.DrawString(spriteBatch, pos + textOffset + new Vector2(0, 40), $"SUBOBJECTIVE: {subObjective.DebugTag} ({subObjective.GetPriority(ObjectiveManager)})", Color.White, Color.Black);
                    }
                }
            }
