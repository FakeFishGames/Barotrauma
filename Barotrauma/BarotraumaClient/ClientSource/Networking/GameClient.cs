...
namespace Barotrauma.Networking
{
    sealed class GameClient : NetworkMember
    {
        ...
        private void ReadDataMessage(IReadMessage inc)
        {
            ...
            switch (header)
            {
                ...
                case ServerPacketHeader.QUERY_STARTGAME:
                    ...
                    // SubEditor test mode: sub synced via XML, skip lobby checks
        ...
        private void ReadSubEditorClientList(IReadMessage inc)
        {
            ...
            byte hostSessionId = inc.ReadByte();
        ...
        private void OnClientPeerDisconnect(PeerDisconnectPacket disconnectPacket)
        {
            ...
            else
            {
                ...
                // Preserve submarine state across SubEditor disconnect
                ...
                // Restore submarine after disconnect
        ...
        private IEnumerable<CoroutineStatus> StartGame(IReadMessage inc)
        {
            ...
            if (gameMode != GameModePreset.MultiPlayerCampaign)
            {
                ...
                // SubEditor test mode: use the in-memory sub
                if (SubEditorScreen.IsSubEditorConnected())
                {
