...
#warning TODO: revise
        ...
        public override void Draw(double deltaTime, GraphicsDevice graphics, SpriteBatch spriteBatch)
        {
            ...
            if (TransformWidget.Enabled)
            {
                ...
                //MapEntity.SelectedList.Where(entity => (entity as Item)?.GetComponent<Wire>() == null).ForEach(entity => GUI.DrawLine(spriteBatch, Cam.WorldToScreen(SelectionCenter), Cam.WorldToScreen(entity.DrawPosition), GUIStyle.Green));
